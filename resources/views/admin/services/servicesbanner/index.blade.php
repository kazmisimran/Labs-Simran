...
<div class="container">
    ...
    <form action="{{route('servicesbanner.update')}}" method="post"   enctype="multipart/form-data" class="container">
        ...
        <div class="form-control">
            ...
            <input type="text" name="title" id="title" value="{{$servicesbanner->title}}" class="@error('title')is-invalid @enderror">
            @error('title')
                <span class="text-danger">{{$message}}</span>
            @enderror
            ...
            <label for="" class="w-25">bread 1</label>
            <input type="text" name="bread1" id="bread1" value="{{$servicesbanner->bread1}}" class="@error('bread1')is-invalid @enderror">
            @error('bread1')
            <span class="text-danger">{{$message}}</span>
            @enderror
            ...
            <label for="" class="w-25">bread 2</label>
            <input type="text" name="bread2" id="bread2" value="{{$servicesbanner->bread2}}" class="@error('bread2')is-invalid @enderror">
            @error('bread2')
            <span class="text-danger">{{$message}}</span>
            @enderror
